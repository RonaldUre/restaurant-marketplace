...
public interface OrderJpaRepository extends JpaRepository<JpaOrderEntity, Long> {
  ...
  @Query("""
      ...
      group by o.id, o.status, o.totalAmount, o.currency, o.createdAt
      """)
  Page<OrderAdminCardProjection> searchPublicCards(
      @Param("customerId") Long customerId,
      @Param("status") com.ronaldure.restaurantmarketplace.restaurant_marketplace.ordering.domain.model.vo.OrderStatus status,
      Pageable pageable);
}
