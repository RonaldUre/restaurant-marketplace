...
/**
 * Handler: enforces auth/tenant rules and delegates to ReportingQuery.
 */
@Service
public class GetDailySalesHandler implements GetDailySalesQuery {

    private final ReportingQuery reportingQuery;
    private final AccessControl access;
    private final CurrentTenantProvider tenants;

    public GetDailySalesHandler(ReportingQuery reportingQuery,
    ...
    public List<DailySalesRow> execute(GetDailySalesQueryParams params) {
        ...
        return reportingQuery.dailySales(tenantId, params.from(), params.to());
    }
