 ...
 * - Optional fields are nullable; "empty address" is represented by all-null address columns.
...
public class JpaRestaurantEntity {
    ...
    // If your MySQL supports JSON, keep columnDefinition="json"; otherwise change to TEXT in both entity and Flyway.
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JpaRestaurantEntity that)) return false;
