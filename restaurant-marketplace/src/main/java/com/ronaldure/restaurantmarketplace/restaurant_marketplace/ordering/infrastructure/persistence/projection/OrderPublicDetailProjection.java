// src/main/java/com/ronaldure/restaurantmarketplace/restaurant_marketplace/ordering/infrastructure/persistence/projection/OrderPublicDetailProjection.java
...
public interface OrderPublicDetailProjection {
    Long getId();
    Long getTenantId();
    Long getCustomerId();
    String getStatus();
